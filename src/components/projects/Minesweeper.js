...
class Minsweeper extends Component {
  ...
  componentDidMount() {
    const grid = document.querySelector(".gridX");
    
    const result = document.querySelector("#result");
    let width = 10;
    let bombAmount = 20;
    const flagsLeft=bombAmount
    document.querySelector("#flags-left").innerHTML=flagsLeft
    let flags = 0;
    let squares = [];
    ...
    function addFlag(square) {
      ...
      if (!square.classList.contains("checked") && flags < bombAmount) {
        ...
        if (!square.classList.contains("flag")) {
          ...
          square.innerHTML = "🚩";
          flags++;
          document.querySelector("#flags-left").innerHTML = bombAmount - flags;
          checkForWin();
        } else {
